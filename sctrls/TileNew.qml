...
FocusScope {
    ...
    property variant descRight
    property variant highLeftIcon
    property variant highRightIcon
    property variant background
    property variant backgroundDefaultImage: "../images/Image-50.png"
    property variant progressValue
